...
public class SortArrayMergeSortLeetcode912 {
	...
	private void merge(int[] arr, int[] temp, int low, int mid, int high) {
		...
		// if the left array is exhausted than we dont need to copy the elements of
		// right array in original array
		// because those elements are already in correct position in the original array.
		// but if right array is exhausted than we are using one logic to copy all the
		// elements of left sub array into the original array
