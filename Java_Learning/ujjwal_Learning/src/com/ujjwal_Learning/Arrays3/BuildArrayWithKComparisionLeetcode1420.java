...
public class BuildArrayWithKComparisionLeetcode1420 {
	...
	// dfs(... i, currMax, currCost) the number of ways to build the valid array
	// `arr[i:]`
	// keeping in mind that current maximum element is `currMax` and current search
	// cost is `currCost`
